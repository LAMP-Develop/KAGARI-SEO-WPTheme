...
<li class="nav-item"><a class="nav-link text-dark" href="<?php echo $home; ?>/case/">導入事例</a></li>
...
<li class="nav-item">
<a class="btn btn-sm btn-primary" href="https://analysis.kagari.ai/sign-up"><i class="fab fa-google mr-2"></i>無料トライアル</a>
</li>
</ul>
</div>
</div>
